...
class FocalLoss(nn.Module):
    ...
    def __init__(self, gamma=0, eps=1e-7, class_weight = None):
        super(FocalLoss, self).__init__()
        self.gamma = gamma
        self.eps = eps
        #self.ce = torch.nn.BCEWithLogitsLoss()
        self.ce = torch.nn.CrossEntropyLoss(weight = class_weight)
...
class AngleLoss_V2(nn.Module):
    def __init__(self):
        super(AngleLoss_V2, self).__init__()
        self.it = 0
        self.LambdaMin = 5.0
        self.LambdaMax = 1500.0
        self.lamb = 1500.0
